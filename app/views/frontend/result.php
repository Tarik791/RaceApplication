<?php $this->view("frontend/header", $data); ?>
    ...
    <table class="table table-bordered table-striped table-condensed cf">
                                  ...
                                  <td data-title="Code"><?=$result->id?></td>

                                      <td data-title="Code"><?=$result->fullname?></td>
                                      <td data-title="Code"><?=$result->url_address?></td>
                                      <td data-title="Company"><?=$result->distance?></td>
                                      <td data-title="Company"><?=$result->time?></td>
